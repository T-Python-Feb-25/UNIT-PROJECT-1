...
# class to handel all the functions related to the university courses
class Course(FilesHandlers):
    ...
    def __int__(self, course_name: str, crn: str, start_date: date, end_date: date, start_time: time, end_time: time,
                price_per_class: float, number_of_students: int, max_number_of_students: int):
        ...
        self.__max_number_of_students=max_number_of_students
    ...
    def set_price_per_class(self, price_per_class: float):
        self.__price_per_class = price_per_class

    def set_number_of_students(self, number_of_students: int):
        self.__number_of_students = number_of_students

    def set_max_number_of_students (self, max_number_of_students: int):
        self.__max_number_of_students = max_number_of_students
    ...
    def get_max_number_of_students (self):
        return self.__max_number_of_students
